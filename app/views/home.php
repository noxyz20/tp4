...
<div class="container">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <div class="row">
            <div class="col-4">
                ...
                <div class="media text-muted pt-3">
                    ...
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <strong class="d-block text-gray-dark"><span class="text-primary">Last tweet : </span>@housni2riffle</strong>
            ...
            <div class="col-8">
                <h1>Bienvenue sur la plateforme de gestion de fournitures de bureau de l'entreprise <span class="text-warning font-weight-bold">tp4</span>: <small>powered by Franck Colonna</small></h1>
